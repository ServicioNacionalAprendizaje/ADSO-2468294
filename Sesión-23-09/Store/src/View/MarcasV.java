 ...
 * @author ariel
 */
public class MarcasV extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarcasV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
